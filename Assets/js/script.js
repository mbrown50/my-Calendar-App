...
$(function () {
  ...
  let showTasks = function (element) { // "this" div class time-block
    ...
    */
    ...
    element.getElementsByTagName('textarea') //[0].innerHTML("myTask")
    console.log("myTasks");
  }
  ...
  let mySave = function (element) { // "this" is button class saveBtn
  ...
  let setHourColors = function (element) { // "this" is div class time-block
    ...
    */
    ...
    time_block_id = time_block_id.replace("hour-", "");
